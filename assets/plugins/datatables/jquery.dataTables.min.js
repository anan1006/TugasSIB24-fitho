...
(function (l) {
   ...
   function Za(a) {
      ...
      if (d || (!t && !h && !e && g == oa(a) && g == m.length)) for (v = 0; v < g; v++) (k = ua(a, v)), null !== k && (c[k].sWidth = K(m.eq(v).width()));
         ...
         for (v = 0; v < k.length; v++)
            (w = c[k[v]]), (m[v].style.width = null !== w.sWidthOrig && "" !== w.sWidthOrig ? K(w.sWidthOrig) : ""), w.sWidthOrig && h && l(m[v]).append(l("<div/>").css({ width: w.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
   ...
   u.defaults = {
      ...
      oLanguage: {
         ...
         sEmptyTable: "Data anime tidak ada",
         ...
         sSearchPlaceholder: "",
         sUrl: "",
         sZeroRecords: "Data yang kamu cari gaada :P",
      },
